...
import { Package, Palette, Truck, Check } from "lucide-react"
...
const steps = [
  {
    ...
    description: "Explora el catálogo y encuentra la opción ideal para tu marca, tu equipo o tu proyecto.",
  },
  {
    number: "02",
    icon: Palette,
    title: "Diseña y personaliza",
    description: "Ajusta colores, impresión o bordado y visualiza cómo se verá tu diseño antes de producirlo.",
  },
  {
    number: "03",
    icon: Truck,
    title: "Ordena y recibe",
    description: "Define cantidades, confirma tu pedido y recibe tus promocionales donde los necesites.",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-black">
            Elige, diseña y ordena promocionales de forma simple
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            En solo 3 pasos tendrás tus artículos personalizados listos para entregar
          </p>
        </div>
